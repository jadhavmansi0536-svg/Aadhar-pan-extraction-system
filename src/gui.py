...
from src.image_processor import preprocess_image, load_image
from src.ocr_processor import extract_text
from src.pdf_processor import pdf_to_images, extract_text_from_pdf
...
class ExtractionApp:
    ...
    def process_file(self, file_path):
        ...
        # ---------------- PDF ----------------
        if extension == ".pdf":
            # Attempt to extract direct digital text first
